 ...
 */
public class datapenjual extends javax.swing.JFrame {

    /**
     * Creates new form datapenjual
     */
    public datapenjual() {
        initComponents();
        tampilan();
    ...
    private void initComponents() {
        ...
        penjual = new javax.swing.JTable();
        jButton1 = new javax.swing.JButton();
        jLabel1 = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        penjual.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(penjual);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(datapenjual.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new datapenjual().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable penjual;
